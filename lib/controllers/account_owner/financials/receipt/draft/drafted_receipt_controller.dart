...
class DraftedReceiptController extends getx.GetxController {
  ...
  final TextEditingController searchDraftedReceiptController = TextEditingController();
  ...
  void dispose() {
    ...
    searchDraftedReceiptController.dispose();
    super.dispose();
  }
}