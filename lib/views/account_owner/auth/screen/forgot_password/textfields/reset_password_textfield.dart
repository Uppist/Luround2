...
class ResetPasswordTextField extends StatefulWidget {
  ResetPasswordTextField({super.key,required this.onChanged, required this.labelText, required this.keyboardType, required this.textInputAction, required this.textController, this.onFocusChanged, required this.isObscured, required this.validator,});
