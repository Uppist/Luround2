...
class _RegisterPage1State extends State<RegisterPage1> {
  ...
  void dispose() {
    ...
    controller.emailController.removeListener(() {
      setState(() {
        // Check if the text field is empty or not
        controller.isFirstPageButtonEnabled = controller.emailController.text.isEmpty;
      });
    });
    super.dispose();
  }
