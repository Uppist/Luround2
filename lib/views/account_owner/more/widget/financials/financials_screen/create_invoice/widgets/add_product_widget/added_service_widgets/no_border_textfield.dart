...
class NoBorderTextFieldForInvoice extends StatefulWidget {
  const NoBorderTextFieldForInvoice({super.key,required this.onChanged, required this.hintText, required this.keyboardType, required this.textInputAction, required this.initialValue, this.onFocusChanged,});
  ...
  @override
  State<NoBorderTextFieldForInvoice> createState() => _NoBorderTextFieldForInvoiceState();
}

class _NoBorderTextFieldForInvoiceState extends State<NoBorderTextFieldForInvoice> {
