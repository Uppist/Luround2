...
Future<void> selectQuoteDateBottomSheet({required BuildContext context, required VoidCallback onCancel, required VoidCallback onApply,}) async{
              ...
              children: [
                ...
                CalendarDatePicker2(
                  ...
                  onValueChanged: (dates) {
                    controller.selectedQuoteDate(dates);
                    debugPrint("${controller.quoteDate}");
                  },
                ),
                SizedBox(height: 20.h,),
                Padding(
