...
class ClientEmailTextField extends StatefulWidget {
  const ClientEmailTextField ({super.key,required this.onChanged, required this.hintText, required this.keyboardType, required this.textInputAction, required this.controller,});
  //final String initialValue;
  final TextInputType keyboardType;
  final String hintText;
  final TextInputAction textInputAction;
  ...
  @override
  State<ClientEmailTextField> createState() => _ClientEmailTextFieldState();
}

class _ClientEmailTextFieldState extends State<ClientEmailTextField> {
