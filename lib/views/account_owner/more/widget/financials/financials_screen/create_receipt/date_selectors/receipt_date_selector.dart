...
Future<void> selectReceiptDateBottomSheet({required BuildContext context, required VoidCallback onCancel, required VoidCallback onApply,}) async{
            ...
            child: Column(
              ...
              children: [
                ...
                CalendarDatePicker2(
                  ...
                  value: controller.datesForReceipt,
                  onValueChanged: (dates) {
                    controller.selectedReceiptDate(dates);
                    debugPrint("${controller.receiptDate}");
                  },
                ),
                SizedBox(height: 20.h,),
                Padding(
