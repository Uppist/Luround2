...
class NoBorderTextFieldForReceipt extends StatefulWidget {
  const NoBorderTextFieldForReceipt({super.key,required this.onChanged, required this.hintText, required this.keyboardType, required this.textInputAction, required this.initialValue, this.onFocusChanged,});
  ...
  @override
  State<NoBorderTextFieldForReceipt> createState() => _NoBorderTextFieldForReceiptState();
}

class _NoBorderTextFieldForReceiptState extends State<NoBorderTextFieldForReceipt> {
