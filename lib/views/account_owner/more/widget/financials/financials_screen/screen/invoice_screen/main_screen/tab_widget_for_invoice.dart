...
class InvoiceScreenTab extends StatefulWidget {
  ...
  @override
  State<InvoiceScreenTab> createState() => _InvoiceScreenTabState();
}

class _InvoiceScreenTabState extends State<InvoiceScreenTab> with SingleTickerProviderStateMixin {
