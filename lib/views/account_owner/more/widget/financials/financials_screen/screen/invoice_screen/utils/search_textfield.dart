...
class InvoicesSearchTextField extends StatefulWidget {
  const InvoicesSearchTextField({super.key, required this.onFieldSubmitted, required this.hintText, required this.keyboardType, required this.textInputAction, required this.textController, this.onFocusChanged, required this.onTap,});
  ...
  @override
  State<InvoicesSearchTextField> createState() => _InvoicesSearchTextFieldState();
}

class _InvoicesSearchTextFieldState extends State<InvoicesSearchTextField> {
