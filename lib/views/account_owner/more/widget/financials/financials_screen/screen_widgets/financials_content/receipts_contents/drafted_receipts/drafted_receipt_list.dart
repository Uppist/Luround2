...
class _DraftedReceiptListState extends State<DraftedReceiptList> {
  ...
  void initState() {
    super.initState();
    savedReceiptFuture = service.getUserDraftedReceipt(); 
  }
    ...
    return FutureBuilder<List<ReceiptResponse>>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData) {
          ...
          service.filteredDraftedReceiptsList.clear();
          service.filteredDraftedReceiptsList.addAll(data); 
          return Obx(
            () {
              return service.filteredDraftedReceiptsList.isNotEmpty ? Expanded(
