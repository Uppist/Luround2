...
class SearchBankTextField extends StatefulWidget {
  const SearchBankTextField({super.key, required this.onFieldSubmitted, required this.hintText, required this.keyboardType, required this.textInputAction, required this.textController, this.onFocusChanged, this.onTap,});
  ...
  @override
  State<SearchBankTextField> createState() => _SearchBankTextFieldState();
}

class _SearchBankTextFieldState extends State<SearchBankTextField> {
