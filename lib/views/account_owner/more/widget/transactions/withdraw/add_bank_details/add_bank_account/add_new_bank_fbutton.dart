...
class AddAccountForTrxFromButton extends StatefulWidget {
  const AddAccountForTrxFromButton({super.key, required this.wallet_balance,});
  final int wallet_balance;

  @override
  State<AddAccountForTrxFromButton> createState() => _AddAccountForTrxFromButtonState();
}

class _AddAccountForTrxFromButtonState extends State<AddAccountForTrxFromButton> {
