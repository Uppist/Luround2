...
import 'package:luround/views/account_owner/services/widget/edit_service/step_tabs/step_1/normal_textfield.dart';
...
class _Step1PageEditState extends State<Step1PageEdit> {
  ...
  void initState() {
    ...
    controller.serviceNameControllerEdit.addListener(() {
      setState(() {
        controller.ispriceButtonEnabledEdit.value = controller.serviceNameControllerEdit.text.isNotEmpty;
      });
    });
    super.initState();
  }
