...
class PackageServiceTimelineEdit extends StatelessWidget {
  PackageServiceTimelineEdit({super.key});
    ...
    return Obx(
      () {
        return DropdownButtonFormField<String>(
          ...
          value: controller.serviceTimelineEdit.value,
          onChanged: (String? newValue) {
            controller.serviceTimelineEdit.value = newValue!;
            debugPrint("selected timeline: ${controller.serviceTimelineEdit.value}");
          },
          ...
          items: controller.listOfServiceTimelineEdit
