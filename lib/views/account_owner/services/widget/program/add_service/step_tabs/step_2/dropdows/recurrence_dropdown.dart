...
class ProgramServiceRecurrence extends StatelessWidget {
  ProgramServiceRecurrence({super.key});
      ...
      () {
        return DropdownButtonFormField<String>(
          ...
          onChanged: (String? newValue) {
            ...
            if(controller.serviceRecurrence.value == 'Custom'){
              customRecurenceAlert(
                selectedValue : controller.serviceRecurrence,
          ...
          items: controller.listOfServiceRecurrence
