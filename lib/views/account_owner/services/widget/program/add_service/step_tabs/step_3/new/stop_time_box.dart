...
class StopTimeBoxProgram extends StatefulWidget {
  const StopTimeBoxProgram({super.key});

  @override
  State<StopTimeBoxProgram> createState() => _StopTimeBoxProgramState();
}

class _StopTimeBoxProgramState extends State<StopTimeBoxProgram> {
