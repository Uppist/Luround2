...
import 'package:luround/views/account_owner/services/widget/program/edit_service/step_tabs/step_1/step_1_edit.dart';
import 'package:luround/views/account_owner/services/widget/program/edit_service/step_tabs/step_2/step_2_edit.dart';
import 'package:luround/views/account_owner/services/widget/program/edit_service/step_tabs/step_3/step_3_edit.dart';
...
class _EditProgramServiceScreenState extends State<EditProgramServiceScreen> {
        ...
        () {
          return Stepper(
            ...
            steps: [
              Step(
                title: Text(""), 
                content: Step1PageProgramServiceEdit(
              ...
              Step(
                ...
                content: Step2PageProgramServiceEdit(
                  onNext: () {
                    if(controller.curentStepEdit.value < 2) {             
                      controller.curentStepEdit.value = controller.curentStepEdit.value + 1;
                      print("current step: ${controller.curentStepEdit.value}");
