...
Future<void> selectStartDateBottomSheetEdit({required BuildContext context, required VoidCallback onCancel, required VoidCallback onApply,}) async{
            ...
            child: Column(
              ...
              children: [
                ...
                CalendarDatePicker2(
                  ...
                  value: controller.datesStopListEdit,
                  onValueChanged: (dates) {
                    if (dates.isNotEmpty) {
                      controller.selectedStartDateEdit(dates);
                    }
                  },
                ),
                SizedBox(height: 20.h,),
...
Future<void> selectStopDateBottomSheetEdit({required BuildContext context, required VoidCallback onCancel, required VoidCallback onApply,}) async{
  showModalBottomSheet(
    isScrollControlled: true,
    clipBehavior: Clip.antiAliasWithSaveLayer,
    elevation: 2,
            ...
            child: Column(
              ...
              children: [
                ...
                CalendarDatePicker2(
                  ...
                  onValueChanged: (dates) {
                    if (dates.isNotEmpty) {
                      controller.selectedStopDateEdit(dates);
                    }
                  },
                ),
                SizedBox(height: 20.h,),
