...
class TimeRangeSelectorEdit extends StatefulWidget {
  const TimeRangeSelectorEdit({super.key, required this.index});
  final int index;

  @override
  State<TimeRangeSelectorEdit> createState() => _TimeRangeSelectorEditState();
}

class _TimeRangeSelectorEditState extends State<TimeRangeSelectorEdit> {
