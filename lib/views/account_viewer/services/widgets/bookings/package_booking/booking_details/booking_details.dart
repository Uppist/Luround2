...
import 'package:luround/views/account_viewer/services/widgets/bookings/package_booking/booking_details/custom_text_row.dart';
import 'package:luround/views/account_viewer/services/widgets/bookings/package_booking/payment_folder/payment_screen.dart';
...
class BookingDetailsPackage extends StatelessWidget {
  BookingDetailsPackage({super.key, required this.serviceId, required this.service_name, required this.date, required this.time, required this.service_charge_virtual, required this.service_charge_in_person, required this.service_provider_id, required this.duration});
