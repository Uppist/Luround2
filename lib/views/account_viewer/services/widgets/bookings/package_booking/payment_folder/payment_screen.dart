...
import 'package:luround/views/account_viewer/services/widgets/bookings/package_booking/payment_folder/black_card_for_accviewer.dart';
import 'package:luround/views/account_viewer/services/widgets/bookings/package_booking/payment_folder/green_card_for_accviewer.dart';
import 'package:luround/views/account_viewer/services/widgets/bookings/package_booking/payment_folder/loading_black_card.dart';
import 'package:luround/views/account_viewer/services/widgets/bookings/package_booking/payment_folder/upload_receipt_widget.dart';
...
class PaymentScreenPackage extends StatefulWidget {
  const PaymentScreenPackage({super.key, required this.amount, required this.service_name, required this.serviceId, required this.time, required this.duration, required this.date, required this.service_provider_id, });
  final String amount;
  ...
  @override
  State<PaymentScreenPackage> createState() => _PaymentScreenPackageState();
}
