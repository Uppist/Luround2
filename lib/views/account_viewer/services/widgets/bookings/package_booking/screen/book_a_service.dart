...
import 'package:luround/views/account_viewer/services/widgets/bookings/package_booking/booking_details/booking_details.dart';
import 'package:luround/views/account_viewer/services/widgets/bookings/package_booking/step_tabs/step_1/step_1.dart';
import 'package:luround/views/account_viewer/services/widgets/bookings/package_booking/step_tabs/step_2/step_2.dart';
...
class BookAppointmentScreenPackage extends StatefulWidget {
  const BookAppointmentScreenPackage({super.key, required this.serviceId, required this.service_name, required this.service_provider_id, required this.date, required this.time, required this.duration, required this.service_charge_virtual, required this.service_charge_in_person,});
  ...
  @override
  State<BookAppointmentScreenPackage> createState() => _BookAppointmentScreenPackageState();
}

class _BookAppointmentScreenPackageState extends State<BookAppointmentScreenPackage> {
