...
import 'package:luround/views/account_viewer/services/widgets/bookings/regular_booking/book_a_service_one-ff/payment_folder/payment_screen.dart';
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomTextRow(
                          leftText: "Time",
                          rightText: controller.selectedAvailableTime.isNotEmpty ? controller.selectedAvailableTime.value : time
                        ),
                        Divider(color: AppColor.textGreyColor, thickness: 0.2),
                        SizedBox(height: 10.h,),
