...
import 'package:luround/views/account_viewer/services/widgets/bookings/regular_booking/book_a_service_retainer/payment_folder/black_card_for_accviewer.dart';
import 'package:luround/views/account_viewer/services/widgets/bookings/regular_booking/book_a_service_retainer/payment_folder/green_card_for_accviewer.dart';
import 'package:luround/views/account_viewer/services/widgets/bookings/regular_booking/book_a_service_retainer/payment_folder/loading_black_card.dart';
import 'package:luround/views/account_viewer/services/widgets/bookings/regular_booking/book_a_service_retainer/payment_folder/upload_receipt_widget.dart';
...
class PaymentScreenRegularRetainer extends StatefulWidget {
  const PaymentScreenRegularRetainer({super.key, required this.amount, required this.service_name, required this.serviceId, required this.time, required this.service_timeline, required this.date, required this.service_provider_id, });
  ...
  @override
  State<PaymentScreenRegularRetainer> createState() => _PaymentScreenRegularRetainerState();
}

class _PaymentScreenRegularRetainerState extends State<PaymentScreenRegularRetainer> {
                          ...
                          return service.isLoading.value ? Loader() : RebrandedReusableButton(
                            ...
                            ? () async{
                              await service.bookUserService(
                                ...
                                duration: widget.service_timeline, 
