...
class PackageServiceListWeb extends StatefulWidget {
  const PackageServiceListWeb({super.key, required this.userName});
...
class _PackageServiceListWebState extends State<PackageServiceListWeb> {
  ...
  Future<void> _refresh() async {
    ...
    // Fetch new data here
    final List<UserServiceModel>  newData = await userService.getUserPackageServices(userName: widget.userName);
  ...
  void initState() {
    super.initState();
    //regular services
    userService.getUserPackageServices(userName: widget.userName).then(
      (value) {
        // Update the UI with the new data
        userService.filterSearchServicesList.clear();
